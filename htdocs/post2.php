...
//    $rhoin12 = addslashes($rhoin12);
    ...
    $date0 = date('U');
    $query = "INSERT INTO tasks(started,date,progress,done,maxIsteps, email, data,formula0,formula1,formula12,rhoin0,rhoin1,rhoin12,slab,energy,qmin,qmax,nslab) VALUES(0,'$date0','0','0','$maxIsteps','$email', '$data','$formula0','$formula1','$formula12','$rhoin0','$rhoin1','$rhoin12','$slab','$energy','$qmin','$qmax','$nslab')";
    //die($query);
